...
<body>
    <div id="root-header" class="header">
        ...
        <h2 style="color: cyan">A Servlet/JSP-based Multi-tiered Enterprise Application Using A Tomcat Container</h2>
    </div>
    <hr>

    <div class="user-message">
        <p>You are connected to the Project 3 Enterprise System database as <span class="user-level">client-level</span>
            user.</p>
        <p>Please enter any SQL Query or update command in the box below.</p>
    </div>

    <div>
        <form action="clientservlet" method="post" class="input-area">
